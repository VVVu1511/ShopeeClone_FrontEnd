        ...
        <div className="bg-orange-500">
            <div className="flex justify-between text-white">
                <div className="flex pt-1 pl-7 text-xs space-x-1.5">
                    <p className="relative mr-1 after:absolute after:inline-block after:ml-1 after:bg-white after:opacity-50 after:w-0.5 after:h-3.5 after:content-[''] hover:opacity-80 cursor-pointer">Kênh người bán</p>
                    <p className="relative after:absolute after:inline-block after:ml-1 after:bg-white after:opacity-50 after:w-0.5 after:h-3.5 after:content-[''] hover:opacity-80 cursor-pointer">Trở thành Người bán Shopee</p>
                    <p className="relative after:absolute after:inline-block after:ml-1 after:bg-white after:opacity-50 after:w-0.5 after:h-3.5 after:content-[''] hover:opacity-80 cursor-pointer">Tải ứng dụng</p>
                ...
                <div className="flex pt-1 pr-7 text-xs space-x-1.5">
                    ...
                    <p className="relative mr-1 after:absolute after:inline-block after:ml-1 after:bg-white after:opacity-50 after:w-0.5 after:h-3.5 after:content-[''] hover:opacity-80 cursor-pointer">Đăng ký</p>
            ...
            <div class="flex pl-5 pb-5 pt-2">
                ...
                <div className="rounded-md bg-white  pt-1 pr-1 pb-1 h-10 w-4/6 place-content-between mt-5">
                    ...
                    <div className={`flex mt-2 ${style.text_under_search_bar} text-white`}>
                        <p class="cursor-pointer">Máy Quạt Cầm Tay</p>
